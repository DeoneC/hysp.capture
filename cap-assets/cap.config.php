...
define('EMAIL_TEMPLATE_IN_HTML', 'cap.email-in.htm');
define('EMAIL_TEMPLATE_IN_TEXT', 'cap.email-in.txt');

define('EMAIL_TEMPLATE_OUT_HTML', 'cap.email-out.htm');
define('EMAIL_TEMPLATE_OUT_TEXT', 'cap.email-out.txt');
...
define('EMAIL_TO', 'hello@hypersoup.com');
...
define('EMAIL_FROM', 'hello@hypersoup.com');
